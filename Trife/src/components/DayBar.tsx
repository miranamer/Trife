...
const DayBar = ({page, highlighted}) => {
  ...
  return (
    <>
        <div className={`${highlighted ? 'bg-gradient-to-b from-[#f2ebde] to-[#e6dbbd]' : 'bg-[#EEE1BF]'} rounded-md hover:cursor-pointer w-full h-[85px] border-[#746C59] border-[2px] flex`}>
