...
return (
    <div className="w-full h-screen font-dmMono">
        <div className='bg-gradient-to-b from-[#f6f5f4] to-[#dfd6bf] py-[10%] flex flex-col gap-10 items-center justify-center'>
            <h1 className='text-[100px] text-[#a09780]'>Trife</h1>
            <p className='py-2 px-3 bg-gradient-to-r from-[#e4ddca] to-[#aea899] text-[#746C59] font-bold rounded-3xl relative bottom-5'>Tree of Life</p>
            <div className="flex flex-col items-center gap-5 relative top-10">
                <h1 className='text-4xl text-[#a09780]'>Get Started</h1>
                <div className="flex gap-5">
                    <button onClick={() => navigate('/signup')} className='bg-[#746C59] text-[#f5eddf] px-4 py-2 rounded-md'>Sign Up</button>
                    <button onClick={() => navigate('/login')} className='bg-[#746C59] text-[#f5eddf] px-4 py-2 rounded-md'>Log In</button>
                </div>
            </div>
        </div>
        ...
        <div className="p-10 bg-[#f5eddf]">
            ...
            <div className="flex flex-col items-center justify-center w-full gap-10 mt-20 text-2xl">
        ...
        <div className="p-10 bg-[#f5eddf] flex items-center justify-center">
